...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/minimalkv-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12431&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/minimalkv-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `minimalkv` can be installed with:

```
conda install minimalkv
```

It is possible to list all of the versions of `minimalkv` available on your platform with:
